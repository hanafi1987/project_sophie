...
class Users extends ActiveRecord implements IdentityInterface
{
    ...
    const USER_TYPE_DEFAULT = 7;
    const USER_DEFAULT_AVATAR = '/img/avatar/default-avatar.jpg';
    ...
    {
        $checkExist = self::findByEmail($email);
        if (isset($checkExist)) {
            return false;
        } else {
            $users = new Users();
            ...
            $users->email = $email;
            $users->flag = 0;
            $users->param_usertype = self::USER_TYPE_DEFAULT;
            $users->avatar_path = self::USER_DEFAULT_AVATAR;
