...
<h1 class="page-title"> Add Shipping Configuration
    <small>Add New Shipping Configuration, Exceed Minimum Purchase or Quantity Equal to Free Shipping</small>
</h1>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Add Shipping Configuration</span>
        </li>
    </ul>
</div>
        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-body">
                ...
                <div class="form-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-md-line-input">
                                <input type="text" class="form-control" id="min_purchase"
                                       placeholder="Enter Minimum Purchase (RM) Here.." name="ShipConfig[min_purch]"
                                       value="<?= $model->min_purch ?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-md-line-input">
                                <input type="text" class="form-control" id="min_quantity"
                                       placeholder="Enter Minimum Quantity Here. Leave empty if does not need"
                                       name="ShipConfig[min_qtty]" value="<?= $model->min_qtty ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-md-line-input">
                                <input type="text" class="form-control" id="fee"
                                       placeholder="Enter Normal Fee (RM) Here.." name="ShipConfig[fee]"
                                       value="<?= $model->fee ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <small><span class="red">*</span> Normal Fee will be waived after achieved minimum
                                requirement
                            </small>
                        </div>
                    </div>
