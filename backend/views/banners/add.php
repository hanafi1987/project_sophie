...
$this->title = 'Add Banner | Sophie Malaysia';
?>


<h1 class="page-title"> Add Banner
    <small>Add New Banner With It's Title and URL</small>
</h1>
<div class="page-bar">
        ...
        <div class="portlet light portlet-fit portlet-form ">
            <div class="portlet-body">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label for="form_control_1">Browse Banner</label>
                        <div style="clear:both"></div>
