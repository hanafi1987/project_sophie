...
$this->title = 'Edit Product | Sophie Malaysia';
?>


<h1 class="page-title"> Edit Product
    <small>Edit Existing Product</small>
</h1>
<div class="page-bar">
    ...
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-form ">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-md-line-input">
                                    <select id="category_splitter" class="bs-select selectpicker form-control"
                                            name="Products[brand]">
                                        <?php $brand = new Supplier();
                                        $brand->listBrandSelect($model->brand); ?>
                                    </select>
                            ...
                            <div class="col-md-3">
                                ...
                                <span id="price_after_discount"><?php
                                    $discounted_price = (float)$model->unitprice - (float)$model->discounts;
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-12">
                        <button type="submit" class="btn green start">Update</button>
